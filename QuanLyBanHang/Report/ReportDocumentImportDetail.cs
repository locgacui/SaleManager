...
{
    public partial class ReportDocumentImportDetail : DevExpress.XtraReports.UI.XtraReport
    {
        public ReportDocumentImportDetail()
        {
            InitializeComponent();
        }
        ...
        public void BindDataDocument()
        {
            ...
            lb_NhaCungCap.DataBindings.Add("Text", document, "NameSupplier");
            lb_Kho.DataBindings.Add("Text", document, "NameWarehouse");
